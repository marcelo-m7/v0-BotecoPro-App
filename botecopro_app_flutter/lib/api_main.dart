...
import 'theme.dart';
import 'pages/home_page_api.dart';
import 'pages/tables_page_api.dart';
...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
  ...
  final Map<NavigationTab, Widget> _screens = {
    ...
    NavigationTab.tables: const TablesPageAPI(),
    // Adicionaremos as outras telas conforme formos adaptando
    NavigationTab.products: const Scaffold(body: Center(child: Text('Telas em desenvolvimento'))),
    NavigationTab.recipes: const Scaffold(body: Center(child: Text('Telas em desenvolvimento'))),
    NavigationTab.production: const Scaffold(body: Center(child: Text('Telas em desenvolvimento'))),
  };
